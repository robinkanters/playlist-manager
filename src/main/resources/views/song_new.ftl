<#-- @ftlvariable name="" type="no.kanters.playlistmgr.controllers.PlaylistSongController.NewPayload" -->
<#include "_base.ftl">

<#macro title>New Song in '${playlistName}'</#macro>
...
<#macro content>
    <div>
        <h2>New song in '${playlistName}'</h2>
